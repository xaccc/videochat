...
<html>
	...
	<body>
		<a href="#edit-mediaService" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-mediaService" class="content scaffold-edit" role="main">
			<h1><g:message code="default.edit.label" args="[entityName]" /></h1>
			<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<g:hasErrors bean="${mediaServiceInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${mediaServiceInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${mediaServiceInstance?.version}" />
				<fieldset class="form">
